...
<svg width="150px" height="20px" viewBox="0 0 150 20" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
    <title>FOSSA Project Status</title>
    <desc>FOSSA Project Status</desc>
    <defs>
        <style>
            @font-face {
                font-family: 'Open Sauce Two';
                src:
                  url('https://s3-us-west-1.amazonaws.com/fossa-site/fonts/OpenSauceTwo-Regular.woff2') format('woff2'),
                  url('https://s3-us-west-1.amazonaws.com/fossa-site/fonts/OpenSauceTwo-Regular.woff') format('woff'),
                  url('https://s3-us-west-1.amazonaws.com/fossa-site/fonts/OpenSauceTwo-Regular.ttf') format('truetype'),
                  url('https://s3-us-west-1.amazonaws.com/fossa-site/fonts/OpenSauceTwo-Regular.svg#OpenSauceTwo-Regular') format('svg');
                font-weight: normal;
                font-style: normal;
                font-display: swap;
            }
            ...
            @font-face {
                font-family: 'Open Sauce Two';
                src:
                    url('https://s3-us-west-1.amazonaws.com/fossa-site/fonts/OpenSauceTwo-SemiBold.woff2') format('woff2'),
                    url('https://s3-us-west-1.amazonaws.com/fossa-site/fonts/OpenSauceTwo-SemiBold.woff') format('woff'),
                    url('https://s3-us-west-1.amazonaws.com/fossa-site/fonts/OpenSauceTwo-SemiBold.ttf') format('truetype'),
                    url('https://s3-us-west-1.amazonaws.com/fossa-site/fonts/OpenSauceTwo-SemiBold.svg#OpenSauceTwo-SemiBold') format('svg');
                font-weight: 600;
                font-style: normal;
                font-display: swap;
            }
